...
using CA1_Task3.Models;
using CA1_Task3.Providers;
using CA1_Task3.Results;
using Newtonsoft.Json;

namespace CA1_Task3.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        {
            try {
                var secret = "6Le2jxEaAAAAALRPpUnxtm-r_tJxBqQsaTwSQDw1";
